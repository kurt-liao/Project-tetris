var TetrisView = function(model){
    ...
    this.setting = function(){
        ...
        document.getElementById('img').style.backgroundImage = 'url(img/B10415031.jpg)';
        document.getElementById('bestScore').style.color = "pink";
        document.getElementById('score').style.color = "red";
        document.getElementById('info').style.fontFamily = 'cursive';
        document.getElementsByClassName('text')[0].style.fontFamily = 'cursive';
        document.getElementsByClassName('text')[1].style.fontFamily = 'cursive';
        document.getElementsByClassName('text')[2].style.fontFamily = 'cursive';
    }
};
