var TetrisView = function(model){
    ...
    this.setting = function(){
        ...
        document.getElementById('img').style.backgroundImage = 'url(img/B10415025.jpg)';
        document.getElementById('bestScore').style.color = "white";
        document.getElementById('score').style.color = "white";
        document.getElementById('info').style.fontFamily = 'fantasy';
        document.getElementsByClassName('text')[0].style.fontFamily = 'fantasy';
        document.getElementsByClassName('text')[1].style.fontFamily = 'fantasy';
        document.getElementsByClassName('text')[2].style.fontFamily = 'fantasy';
    }
};
